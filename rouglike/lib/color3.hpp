...
namespace dye
{
    ...
    public:
        item(T t)                               :  thing(std::move(t)), color(hue3::get())       {}
        item(T t, int a)                        :  thing(std::move(t)), color(hue3::itoc(a))     {}
        item(T t, int a, int b)                 :  thing(std::move(t)), color(hue3::itoc(a, b))  {}
        item(T t, std::string a)                :  thing(std::move(t)), color(hue3::stoc(a))     {}
        item(T t, std::string a, std::string b) :  thing(std::move(t)), color(hue3::stoc(a, b))  {}

        item<T> & invert()
        {
            color = hue3::invert(color);
            return *this;
        }
